...
-- Add Two Sum problem, 
INSERT INTO problems (leetcode_num, problem_name, description, approach_id, pseudocode) 
...
copy right to left. return left.'
);
...
increment count, else decrement count. Return candidate'
);



-- Add Summary Ranges problem. Note no approach.  
INSERT INTO problems (leetcode_num, problem_name, description, pseudocode)
...
that cover all the numbers in the array exactly.', 'Initialize pointer i to mark start of 
